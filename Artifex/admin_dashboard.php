...
if ($conn) {
    // Fetch all events
    $stmt_events = $conn->prepare("SELECT * FROM Events");
    $stmt_events->execute();
...
<div class="admin-nav">
    ...
    <a href="gestione_date.php">Gestione Date Eventi</a> |
    <a href="gestione_guide.php">Gestione Guide</a> |
        ...
        <table>
            ...
            <?php foreach ($events as $event): ?>
                <tr>
                    ...
                    <td><?php echo $event['GuideID']; ?></td>
                    <td><?php echo $event['Capacity']; ?></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
        </table>
        <p><a href="aggiungi_evento.php">Aggiungi Nuovo Evento</a></p>
    <?php endif; ?>
</div>
...
<div class="section">
    ...
    <?php else: ?>
        ...
        <p><a href="aggiungi_data_evento.php">Aggiungi Nuova Data Evento</a></p>
    <?php endif; ?>
</div>
